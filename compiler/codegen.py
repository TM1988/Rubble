...
class CodeGen:
    ...
    def _emit_stmt(self, node: Node):
        ...
        elif isinstance(node, (RecipeDecl, BlueprintDecl, EnumDecl, ConstDecl, Decorator, ModuleDecl, MethodDecl, TypeAliasDecl, UnionType, IntersectionType, NullableType, TupleType, RecordLit, TuplePattern, ArrayType, MapType, SetType, OptionalChainExpr, NullCoalesceExpr, GatherStmt, MacroDecl, MacroCall, ConstFnDecl)):
